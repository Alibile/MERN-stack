...
import { registrationUser,activateUser, loginUser,logoutUser, updateAccessToken,updateProfilePicture, getUserInfo,socialAuth, updateUserInfo, updatePassword } from "../controller/user.controller";
...
useRouter.put("/update-user-profile",isAuthenticated,updateProfilePicture);
